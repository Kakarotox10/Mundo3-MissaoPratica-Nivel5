        ...
        try {
            ...
            for (Movimento movimentoCollectionOldMovimento : movimentoCollectionOld) {
                if (!movimentoCollectionNew.contains(movimentoCollectionOldMovimento)) {
                    ...
                    illegalOrphanMessages.add("Você deve manter o Movimento " + movimentoCollectionOldMovimento + " já que seu campo idProduto não é anulável.");
                }
            }
            if (illegalOrphanMessages != null) {
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (Movimento movimentoCollectionOrphanCheckMovimento : movimentoCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("Este produto (" + produto + ") não pode ser destruído já que o Movimento " + movimentoCollectionOrphanCheckMovimento + " em seu campo movimentoCollection possui um campo idProduto não anulável.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
