    ...
    public void create(PessoaJuridica pessoaJuridica) throws IllegalOrphanException, PreexistingEntityException, Exception {
        ...
        if (pessoaOrphanCheck != null) {
            ...
            if (oldPessoaJuridicaOfpessoa != null) {
                ...
                illegalOrphanMessages.add("A pessoa " + pessoaOrphanCheck + " já possui um item do tipo PessoaJuridica cuja coluna pessoa não pode ser nula. Faça outra seleção para o campo pessoa.");
            }
        }
        if (illegalOrphanMessages != null) {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findPessoaJuridica(id) == null) {
                    throw new NonexistentEntityException("A pessoa Jurídica com id " + id + " não existe mais.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("A pessoa Jurídica com id " + id + " não existe mais.", enfe);
            }
            Pessoa pessoa = pessoaJuridica.getpessoa();
            if (pessoa != null) {
